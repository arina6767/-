...
# Данные по странам, сферам и налогам
tax_data = {
    "Италия": {
        "Туризм": {
            "Налог на использование флага Италии в декоре": 0,
            "Туристический сбор за проживание": 2,
            "Сбор за вход в перегруженные районы": 5,
            "Налог на сохранение исторического центра": 8
        },
        "Экология": {
            "Налог на одноразовые стаканчики": 0,
            "Сбор за пластиковые бутылки": 2,
            "Сбор за переработку отходов": 5,
            "Налог на въезд авто в центр города": 8
        },
        "Медицина": {
            "Налог на покупку витаминов туристами": 0,
            "Сбор на поддержку местных клиник": 2,
            "Сбор на профилактику заболеваний": 5,
            "Обязательный медсбор для туристов": 8
        },
        "Социальная сфера": {
            "Налог на уличных музыкантов": 0,
            "Сбор за торговлю в туристических местах": 2,
            "Налог на бизнес в исторических районах": 5,
    ...
    "Япония": {
        "Туризм": {
            ...
            "Туристический сбор в отелях": 2,
            "Сбор на содержание храмов": 5,
            "Налог на посещение перегруженных зон": 8
        },
        "Экология": {
            "Налог на пластиковые пакеты": 0,
            "Сбор за упаковку": 2,
            "Сбор за переработку электроники": 5,
            "Налог на превышение потребления энергии": 8
        },
        "Медицина": {
            "Налог на сладости": 0,
            "Налог на сладкие напитки": 2,
            "Сбор на профилактику заболеваний": 5,
            "Налог на вредные продукты": 8
        },
        "Социальная сфера": {
            "Налог на поздние прогулки": 0,
            "Сбор за шум ночью": 2,
            "Сбор с компаний за переработки": 5,
    ...
    "США": {
        "Туризм": {
            ...
            "Сбор за парковку у достопримечательностей": 2,
            "Туристический сбор в отелях": 5,
            "Налог на посещение национальных парков": 8
        },
        "Экология": {
            "Налог на пластиковые трубочки": 0,
            "Сбор за вывоз мусора": 2,
            "Налог на выбросы предприятий": 5,
            "Углеродный налог": 8
        },
        "Медицина": {
            "Налог на фастфуд": 0,
            "Налог на сладкие напитки": 2,
            "Сбор на профилактику ожирения": 5,
            "Налог на ультраобработанную пищу": 8
        },
        "Социальная сфера": {
            "Налог на рекламу": 0,
            "Налог на соцсети": 2,
            "Налог на пустующее жильё": 5,
...
async def handle_tax(message: types.Message):
    ...
    text = (
        f"✅ Вы выбрали:\n{message.text}\n\n"
        f"🎯 Баллы за этот налог: {points}\n"
        f"📊 Всего баллов: {user_scores[uid]}\n"
